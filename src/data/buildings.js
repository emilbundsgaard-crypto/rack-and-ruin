...
export const BUILDINGS = [
  // ---------------------------------------------------------------- compute
  {
    id: 'rack', name: 'Open frame rack', glyph: 'rack', tag: 'FRAME', cat: 'compute', cost: 1_200, slots: 8,
    draw: 0.03, upkeep: 2, color: '#3f7dd6',
    desc: 'Two posts and a prayer. Holds eight units.',
  },
  {
    id: 'rack2', name: 'Enclosed rack', glyph: 'rack', tag: 'RACK', cat: 'compute', cost: 14_000, slots: 18,
    draw: 0.06, upkeep: 9, color: '#4f95e8', req: 'rnd_rack2',
    desc: 'Doors, blanking panels and a sane airflow path.',
  },
  {
    id: 'rack3', name: 'High-density cabinet', glyph: 'rack', tag: 'CABINET', cat: 'compute', cost: 260_000, slots: 34,
    draw: 0.14, upkeep: 55, color: '#63aef7', req: 'rnd_rack3',
    desc: 'Rear-door heat exchanger, deep enough for GPU sleds.',
  },
  {
    id: 'rack4', name: 'Immersion tank', glyph: 'tank', tag: 'IMMERSE', cat: 'compute', cost: 9_500_000, slots: 56,
    draw: 0.6, upkeep: 900, color: '#7fd0ff', req: 'rnd_rack4',
    coolSelf: 0.45,
    desc: 'Dielectric bath. Removes 45% of its own heat and never rattles.',
  },
  {
    id: 'rack5', name: 'Cryo vault', glyph: 'cryo', tag: 'VAULT', cat: 'compute', cost: 1_400_000_000, slots: 84,
  ...
  // ------------------------------------------------------------------ power
  {
    id: 'pdu', name: 'Power strip', glyph: 'plug', tag: 'STRIP', cat: 'power', cost: 400, radius: 2, powerCap: 30,
    draw: 0.02, upkeep: 1, color: '#d8a13a',
    desc: 'Eight sockets on a cable. Spreads 30 kW over two tiles.',
  },
  {
    id: 'pdu2', name: 'Rack PDU', glyph: 'plug', tag: 'PDU', cat: 'power', cost: 6_500, radius: 3, powerCap: 400,
    draw: 0.05, upkeep: 6, color: '#e8b44a', req: 'rnd_pdu2',
    desc: 'Metered, switched, and it will not melt at 40 amps.',
  },
  {
    id: 'pdu3', name: 'Busway tap', glyph: 'busbar', tag: 'BUSWAY', cat: 'power', cost: 140_000, radius: 4, powerCap: 8_000,
    draw: 0.3, upkeep: 90, color: '#f5c95f', req: 'rnd_pdu3',
    desc: 'Overhead busway. Add taps wherever a row grows.',
  },
  {
    id: 'pdu4', name: 'Substation bay', glyph: 'transformer', tag: 'SUBSTN', cat: 'power', cost: 6_800_000, radius: 6, powerCap: 120_000,
    draw: 3, upkeep: 3_400, color: '#ffd980', req: 'rnd_pdu4',
    desc: 'Medium voltage in, three-phase out, humming all night.',
  },
  {
    id: 'pdu5', name: 'HVDC spine', glyph: 'transformer', tag: 'HVDC', cat: 'power', cost: 900_000_000, radius: 9, powerCap: 2_000_000,
    draw: 30, upkeep: 400_000, color: '#ffe9b0', req: 'rnd_pdu5',
    desc: 'One conversion step instead of four. The efficiency is the point.',
  },
  {
    id: 'ups', name: 'UPS cabinet', glyph: 'battery', tag: 'UPS', cat: 'power', cost: 22_000, ride: 12, draw: 0.4,
    upkeep: 40, color: '#c98b2f', req: 'rnd_ups',
    desc: 'Rides through 12 seconds of grid loss. Stack them for longer.',
  },
  {
    id: 'genset', name: 'Diesel genset', glyph: 'engine', tag: 'GENSET', cat: 'power', cost: 48_000, supplyKW: 220,
  ...
  {
    id: 'solar', name: 'Solar array', glyph: 'sun', tag: 'SOLAR', cat: 'power', cost: 130_000, supplyKW: 160,
    upkeep: 25, color: '#4a7fc0', req: 'rnd_solar', solar: true,
    desc: 'Free power between sunrise and sunset. Nothing at 03:00.',
  },
  {
    id: 'wind', name: 'Wind turbine', glyph: 'turbine', tag: 'WIND', cat: 'power', cost: 1_100_000, supplyKW: 900,
    upkeep: 320, color: '#7fa8c8', req: 'rnd_wind', wind: true,
    desc: 'Output rides the weather. Averages well, spikes badly.',
  },
  {
    id: 'turbine', name: 'Gas turbine', glyph: 'flame', tag: 'TURBINE', cat: 'power', cost: 9_200_000, supplyKW: 9_000,
  ...
  {
    id: 'smr', name: 'Small modular reactor', glyph: 'atom', tag: 'REACTOR', cat: 'power', cost: 2_400_000_000, supplyKW: 260_000,
    upkeep: 1_100_000, color: '#5fd0a8', req: 'rnd_smr', heatOut: 900,
    desc: '260 MW behind the fence, refuelled once a decade.',
  },
  {
    id: 'fusion', name: 'Fusion tokamak', glyph: 'star', tag: 'FUSION', cat: 'power', cost: 900_000_000_000, supplyKW: 6_000_000,
  ...
  // ---------------------------------------------------------------- cooling
  {
    id: 'fan', name: 'Box fan', glyph: 'fan', tag: 'FAN', cat: 'cooling', cost: 250, radius: 2, coolCap: 3.5,
    draw: 0.12, upkeep: 1, color: '#3fb98a',
    desc: 'Moves hot air somewhere else. Somewhere else is also the room.',
  },
  {
    id: 'split', name: 'Split AC unit', glyph: 'fan', tag: 'AC UNIT', cat: 'cooling', cost: 5_200, radius: 3, coolCap: 22,
    draw: 0.9, water: 0.004, upkeep: 8, color: '#45c99a', req: 'rnd_split',
    desc: 'A real compressor with a condenser hanging off the wall.',
  },
  {
    id: 'crac', name: 'CRAC unit', glyph: 'coil', tag: 'CRAC', cat: 'cooling', cost: 95_000, radius: 4, coolCap: 190,
    draw: 6.5, water: 0.011, upkeep: 120, color: '#4fdca8', req: 'rnd_crac',
    desc: 'Computer room air conditioning, blowing into a raised floor.',
  },
  {
    id: 'chiller', name: 'Chilled water plant', glyph: 'coil', tag: 'CHILLER', cat: 'cooling', cost: 2_100_000, radius: 5,
  ...
  {
    id: 'freecool', name: 'Free-cooling gallery', glyph: 'louvre', tag: 'ECON', cat: 'cooling', cost: 46_000_000, radius: 6,
  ...
  {
    id: 'adiabatic', name: 'Adiabatic tower', glyph: 'cooltower', tag: 'ADIABAT', cat: 'cooling', cost: 700_000_000, radius: 7,
  ...
  {
    id: 'cryo', name: 'Cryogenic loop', glyph: 'snow', tag: 'CRYO', cat: 'cooling', cost: 90_000_000_000, radius: 9,
  ...
  // ------------------------------------------------------------------ water
  {
    id: 'tank', name: 'Water tank', glyph: 'barrel', tag: 'TANK', cat: 'water', cost: 900, supplyWater: 0.06,
    upkeep: 2, color: '#3b7fd0',
    desc: 'A tank somebody refills. Small, dumb, reliable.',
  },
  {
    id: 'mains', name: 'Mains connection', glyph: 'tap', tag: 'MAINS', cat: 'water', cost: 18_000, supplyWater: 0.85,
    upkeep: 30, waterCost: 2.2, color: '#4390e0', req: 'rnd_mains',
    desc: 'Municipal supply, metered, and the first thing cut in a drought.',
  },
  {
    id: 'well', name: 'Borehole well', glyph: 'well', tag: 'WELL', cat: 'water', cost: 320_000, supplyWater: 9,
    upkeep: 260, draw: 2.4, waterCost: 0.4, color: '#3a78bb', req: 'rnd_well',
    desc: 'Your own aquifer tap. Cheap water, slow recharge.',
  },
  {
    id: 'tower', name: 'Cooling tower', glyph: 'cooltower', tag: 'TOWER', cat: 'water', cost: 4_200_000, supplyWater: 80,
  ...
  {
    id: 'recycler', name: 'Greywater recycler', glyph: 'recycle', tag: 'RECYCLE', cat: 'water', cost: 120_000_000, supplyWater: 1_400,
  ...
  {
    id: 'desal', name: 'Desalination skid', glyph: 'wave', tag: 'DESAL', cat: 'water', cost: 22_000_000_000, supplyWater: 34_000,
