...
export const CONTRACT_TEMPLATES = [
  { id: 'static', name: 'Static site hosting', client: 'Nordbageriet',
    minRep: 0, size: 0.46, pay: 1.00, net: 3, uptime: 0.80, days: 12, penalty: 0.4,
    blurb: 'Six pages and a contact form. It must simply not be down.' },
  { id: 'mail', name: 'Mail & backup', client: 'Halvorsen Revision',
    minRep: 0, size: 0.54, pay: 1.05, net: 4, uptime: 0.85, days: 14, penalty: 0.5,
  ...
  { id: 'intranet', name: 'Corporate intranet', client: 'Mareld Logistics',
    minRep: 4, size: 0.53, pay: 1.15, net: 5, uptime: 0.90, days: 16, penalty: 0.6,
    blurb: 'Payroll, timesheets and a wiki with 4000 orphaned pages.' },
  { id: 'shop', name: 'E-commerce storefront', client: 'Bruun & Datter',
    minRep: 10, size: 0.59, pay: 1.30, net: 9, uptime: 0.95, days: 18, penalty: 0.9,
  ...
  { id: 'genome', name: 'Genomics pipeline', client: 'Institut for Biovidenskab',
    minRep: 42, size: 0.70, pay: 1.55, net: 12, uptime: 0.88, days: 24, penalty: 0.7,
    research: 1.5,
  ...
  { id: 'weather', name: 'Regional weather model', client: 'Meteorologisk Institut',
    minRep: 52, size: 0.71, pay: 1.60, net: 20, uptime: 0.96, days: 26, penalty: 1.2,
    research: 2.5,
  ...
  { id: 'risk', name: 'Financial risk simulation', client: 'Kvist Kapital',
    minRep: 64, size: 0.68, pay: 1.95, net: 26, uptime: 0.99, days: 20, penalty: 2.2,
  ...
  { id: 'finetune', name: 'LLM fine-tuning', client: 'Skyfall Labs',
    minRep: 78, size: 0.74, pay: 2.10, net: 40, uptime: 0.97, days: 22, penalty: 1.6,
    research: 5,
  ...
  { id: 'molecular', name: 'Molecular dynamics', client: 'Farmakon A/S',
    minRep: 92, size: 0.73, pay: 2.05, net: 18, uptime: 0.93, days: 28, penalty: 1.3,
    research: 8,
  ...
  { id: 'pretrain', name: 'Foundation model pretraining', client: 'Aether Research',
    minRep: 120, size: 0.85, pay: 2.60, net: 90, uptime: 0.995, days: 30, penalty: 3.0,
    research: 14,
  ...
  { id: 'sovereign', name: 'Sovereign AI cloud', client: 'Ministeriet for Digitalisering',
    minRep: 160, size: 0.81, pay: 2.90, net: 70, uptime: 0.99, days: 36, penalty: 2.6,
    research: 20,
  ...
  { id: 'climate', name: 'Planetary climate twin', client: 'Earth Systems Consortium',
    minRep: 210, size: 0.85, pay: 3.20, net: 120, uptime: 0.995, days: 40, penalty: 3.4,
    research: 34,
  ...
  { id: 'lattice', name: 'Lattice QCD campaign', client: 'CERN-adjacent collaboration',
    minRep: 280, size: 0.85, pay: 3.40, net: 60, uptime: 0.98, days: 44, penalty: 2.8,
    research: 55,
  ...
  { id: 'synthesis', name: 'Autonomous materials lab', client: 'Helix Foundry',
    minRep: 360, size: 0.85, pay: 3.80, net: 150, uptime: 0.995, days: 48, penalty: 4.0,
    research: 90,
  ...
  { id: 'oracle', name: 'Continental inference grid', client: 'Consortium of everyone',
    minRep: 460, size: 0.85, pay: 4.40, net: 240, uptime: 0.997, days: 55, penalty: 4.5,
    research: 150,
